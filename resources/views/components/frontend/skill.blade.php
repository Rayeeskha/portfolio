...
<section class="cta-full border-top">
    <div class="container-fluid">
        <div class="row position-relative">
            <div class="col-lg-4 padding-less img" style="background-image:url('assets/images/home/photo.png');" ></div><!-- end col -->
                        ...
                        <div class="col-lg-9 col-md-8 col-12">
                            <div class="tab-content ps-lg-4" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-cloud" role="tabpanel" aria-labelledby="pills-cloud-tab">
                                    ...
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">React js</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:84%;">
                                    ...
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Vue js</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:84%;">
                                ...
                                <div class="tab-pane fade" id="pills-smart" role="tabpanel" aria-labelledby="pills-smart-tab">
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Hindi</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:84%;">
                                ...
                                <div class="tab-pane fade" id="pills-apps" role="tabpanel" aria-labelledby="pills-apps-tab">
                                    <div class="progress-box mt-4 pt-2">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:84%;">
                                                <div class="progress-value d-block text-dark h6">70%</div>
                                            </div>
                                        </div>
                                    </div><!--end process box-->
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">Laravel</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:75%;">
                                                <div class="progress-value d-block text-dark h6">75%</div>
                                            </div>
                                    ...
                                    <div class="progress-box mt-4 pt-2">
                                        <h6 class="font-weight-normal">CodeIgniter</h6>
                                        <div class="progress">
                                            <div class="progress-bar position-relative bg-primary" style="width:75%;">
