...
<section class="section pb-3" id="about">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-5">
                <div class="about-hero">
                    <img src="{{ asset('assets/images/home/photo.png') }}" class="img-fluid mx-auto d-block about-tween position-relative" alt="" >
                </div>
            </div><!--end col-->
    ...
    <div class="container-fluid mt-100 mt-60">
        <div class="rounded py-md-5 py-4" style="background: url('assets/images/bg-counter.jpg') center center;">
            <div class="container">
