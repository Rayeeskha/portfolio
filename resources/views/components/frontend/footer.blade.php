    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                ...
                <p class="para-desc mx-auto mt-5">Obviously I'm a Web Developer. Experienced with all stages of the development cycle for dynamic web projects.</p>
...
<footer class="footer footer-bar bg-dark">
    <div class="container text-foot text-center">
        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Khan Rayees All Rights Reserved </p>
    </div><!--end container-->
</footer><!--end footer-->
<!-- Footer End -->
