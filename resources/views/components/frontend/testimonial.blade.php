...
<section class="cta-full">
    <div class="container-fluid">
        <div class="row position-relative">
                            ...
                            <div class="client-review-slider">
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/01.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
                                ...
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/02.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
                                ...
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/03.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
                                ...
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/04.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
                                ...
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <p class="text-muted review-para font-italic mt-3 mb-3">There are many variations of passages of Lorem Ipsum available, by injected humour, or randomised words which don't look even slightly believable. </p>
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/05.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
                                ...
                                <div class="tiny-slide">
                                    <div class="client-review rounded shadow m-2">
                                        ...
                                        <div class="reviewer d-flex align-items-center">
                                            <img src="{{ asset('assets/images/client/06.jpg') }}" class="img-fluid rounded-circle avatar avatar-small me-3" alt="">
                                            <div class="content">
            ...
            <div class="col-lg-4 offset-lg-8 padding-less img order-1" style="background-image:url('assets/images/home/photo1.jpg')" ></div><!-- end col -->    
        </div><!--end row-->
